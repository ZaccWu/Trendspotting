...
parser.add_argument('--result_path', type=str, help='path of the result file', default='result/ts_240124_v2/')
...
parser.add_argument('--model', type=str, help='choose model', default='m4') # m4
...
parser.add_argument('--reg3', type=float, help='reg3', default=1e-5)
...
class WT_SALES(torch.nn.Module):
    ...
    def forward(self, x, label):
        ...
        view_prob = torch.cat([view_prob_V, view_prob_S], dim=0)
        orthogonal = orth_V + orth_S
