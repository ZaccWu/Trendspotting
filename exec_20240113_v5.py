...
parser.add_argument('--result_path', type=str, help='path of the result file', default='result/ts_240113_v5/')
...
class TRENDSPOT2(torch.nn.Module):
    def __init__(self, lag, fea_dim, hid_dim=32, out_channels=32, out_dim=1):
        ...
        self.linear_sales1 = nn.Linear(out_channels * 16, 1)
        self.linear_sales2 = nn.Linear(out_channels * 16, 1)
        self.linear_sales3 = nn.Linear(out_channels * 16, 1)
        self.linear_salesn = nn.Linear(out_channels * 16, 1)
